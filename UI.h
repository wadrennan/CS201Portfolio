...
int selectCol(WINDOW*** gb, int x, int y, int colorpair, int** marked); // allows user to select spot on board; colorpair denotes which player in 2 player mode
void moveSpot(WINDOW*** gb, int x, int num, int y, int colorpair); // moves marked space on board down column to first unmarked space
#endif
